...
export function LinkCard({ link, onClick }: LinkCardProps) {
  return (
    <button
      ...
      onClick={onClick}
    >
      <Card className="max-w-72 group w-full max-h-96 h-full min-h-80 pt-0 shadow-2xl shadow-gray-300/5 hover:shadow-gray-300/10 hover:text-primary hover:bg-secondary/50">
